...
class Highlight extends react_1.Component {
    render() {
        ...
        return (react_1.default.createElement("div", { className: `Highlight ${isScrolledTo ? "Highlight--scrolledTo" : ""}` },
            ...
            react_1.default.createElement("div", { className: "Highlight__parts" }, rects.map((rect, index) => (react_1.default.createElement("div", { onMouseOver: onMouseOver, onMouseOut: onMouseOut, onClick: onClick, key: index, style: Object.assign(Object.assign({}, rect), { backgroundColor: comment.color }), className: `Highlight__part` }))))));
    }
}
